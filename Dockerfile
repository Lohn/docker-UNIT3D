...
RUN apt install -y curl apt-transport-https lsb-release ca-certificates git tmux vim wget zip unzip htop nano build-essential
...
RUN apt install -y supervisor redis-server nginx
RUN apt install -y php-pear php7.2-curl php7.2-dev php7.2-gd php7.2-mbstring php7.2-zip php7.2-mysql php7.2-xml php7.2-fpm
